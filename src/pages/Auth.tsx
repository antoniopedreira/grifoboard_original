      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center p-6 lg:p-12 relative z-20 bg-accent/30">
        ...
        <div className="lg:hidden absolute top-0 left-0 w-full bg-primary p-6 text-center shadow-md">
          ...
          <img
            ...
            alt="Grifo Logo"
            className="grifo-logo-placeholder h-10 mx-auto mb-3 object-contain brightness-0 invert" // Classe para edição no Lovable + Invertido para branco
          />
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <img
              src="/path-to-your-logo.png"
              alt="Grifo Logo"
              className="grifo-logo-placeholder h-14 mx-auto mb-6 object-contain" // Classe para edição no Lovable
              style={{
                filter:
