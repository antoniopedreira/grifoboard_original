...
const Dashboard = () => {
  ...
  // Usar o hook useTaskManager para obter os dados das tarefas
  const { 
    pcpData, 
    weeklyPCPData, 
    tasks, 
  ...
  // Redirecionar se não houver obra ativa
  useEffect(() => {
    if (!session.obraAtiva) {
      navigate("/obras");
    }
  }, [session.obraAtiva, navigate]);
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Análise de desempenho da obra: {session.obraAtiva?.nome_obra}
          </p>
        </div>
